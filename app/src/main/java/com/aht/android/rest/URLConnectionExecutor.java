...
//
//public class URLConnectionExecutor implements ClientExecutor {
//
//    private HttpURLConnection connection;
//
//    URLConnectionExecutor(HttpURLConnection connection) {
...
//        BaseClientResponse<T> response = new BaseClientResponse<>(new BaseClientResponse.BaseClientResponseStreamFactory()
//        {
...
//            try
//            {
//                final CommitHeaderOutputStream commit = new CommitHeaderOutputStream(null,null);
